...
#test_inputs $@
STARTDIR=`pwd`
BASEDIR=("/home/mnadvornik/EXPERIMENTS/2015/2015_001_SPW_Modul5_Axial_output_ventilace/SOLUTION/Mesh/base" \
)
TEMPLTRB=/home/mnadvornik/EXPERIMENTS/2015/2015_001_SPW_Modul5_Axial_output_ventilace/SOLUTION/Mesh/last_2stages_extraout/Modul5_2stages_extra_outlet_ver.2.trb
...
for ITEM in `find $WRDIR -type d -regex '.*/[Mm]esh.*' -printf "%p\n"`  #-size 0 
do
