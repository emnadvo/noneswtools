...
declare DOCTEMPLATE="/home/mnadvornik/mswin/Dokumentace/Reports/projektovy_zapis_new.doc"
declare DEPARTMENT="SPW"
#declare WORKDIR="/mnt/data3/cfd/WORK"
declare WORKDIR="/mnt/data4/cfd/WORK"
...
NEWDIRNAME="$CURRYEAR"_"$NEWPROJID"_"$DEPARTMENT"_"$NEWNAME"
STATUS=0
...
cp -f $DOCTEMPLATE $NEWDIRNAME/SETTINGS/$NEWDIRNAME.doc
#touch $PROJECTDESCR
